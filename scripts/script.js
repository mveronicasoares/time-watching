function habilitaBtn () {
	...
	function enviardados(event){
		...
		else if(document.getElementsByName('numTemporadas')[0].value=="" || document.getElementsByName('numTemporadas')[0].value == undefined || document.getElementsByName('numTemporadas')[0].value.length < 2)
		{
			alert( "Preencha campo\"Quantidade de Temporadas\" corretamente! Não deixe valores em branco e nem menos do que 2 caracteres" );
			document.getElementsByName('numTemporadas')[0].focus();
			return false;
		}else if(document.getElementsByName('numEpisodios')[0].value=="" || document.getElementsByName('numEpisodios')[0].value == undefined || document.getElementsByName('numEpisodios')[0].value.length < 2)
		{
			alert( "Preencha campo \"Episódios\\Temporada\" corretamente! Não deixe valores em branco e nem menos do que 2 caracteres" );
			document.getElementsByName('numEpisodios')[0].focus();
			return false;
		}else if(document.getElementsByName('tempoEpisodio')[0].value=="" || document.getElementsByName('tempoEpisodio')[0].value == undefined || document.getElementsByName('tempoEpisodio')[0].value.length < 2)
		{
			alert( "Preencha campo \"Tempo\\Episódio\" corretamente! Não deixe valores em branco e nem menos do que 2 caracteres" );
